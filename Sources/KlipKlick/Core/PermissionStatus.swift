...
///
/// Both grants are made in System Settings, which means leaving KlipKlick and
...
/// KlipKlick polls nothing at all.
final class PermissionStatus: ObservableObject {
    ...
    /// Backstop for a grant made without ever re-activating KlipKlick.
